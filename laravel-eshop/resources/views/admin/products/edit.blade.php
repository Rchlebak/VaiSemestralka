                            ...
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-2 text-center">
                                        ...
                                        @else
                                            <form action="{{ route('admin.images.setMain', $image->image_id) }}" method="POST" class="d-inline">
                                                @csrf
            ...
            <div class="card-body">
                            ...
                            <div class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <!-- Stock update -->
                                        <form action="{{ route('admin.variants.updateStock', $variant->variant_id) }}"
                                              method="POST" class="d-flex align-items-center gap-1">
                                            @csrf
                                            @method('PUT')
                                            <input type="number" name="stock_qty" class="form-control form-control-sm"
                                                   style="width: 70px;" value="{{ $variant->stock_qty }}" min="0">
                                            <button type="submit" class="btn btn-sm btn-outline-success" title="Uložiť sklad">
                                                <i class="bi bi-check"></i>
                                            </button>
                                        </form>

                                        <!-- Delete -->
                                        <form action="{{ route('admin.variants.destroy', $variant->variant_id) }}"
                                              method="POST" onsubmit="return confirm('Vymazať variant?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-outline-danger">
                                                <i class="bi bi-trash"></i>
                ...
                <form action="{{ route('admin.products.variants.store', $product->product_id) }}" method="POST">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-3">
                            <input type="text" name="size_eu" class="form-control form-control-sm"
                                   placeholder="Veľkosť" required>
                        </div>
                        <div class="col-2">
                            <input type="number" name="stock_qty" class="form-control form-control-sm"
